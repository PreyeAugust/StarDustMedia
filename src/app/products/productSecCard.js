...
import Img3 from "@/assets/united.jpg";
    ...
    <section data-aos="zoom-out" className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="text-center mb-10 max-w-[600px] mx-auto space-y-2">
          <h1 data-aos="zoom-out" className="text-3xl font-bold font-serif uppercase lg:text-4xl">
            Explore Our Products
          </h1>
          <h2 data-aos="zoom-out" className="text-1xl font-serif lg:text-2xl uppercase">
          Stardust Comic Childrens Book
        </h2>
        </div>
