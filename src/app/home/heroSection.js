...
export default function heroSection() {
  return (
    <main className="z-[-2] flex items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover custom-homeHero">
      <div className="absolute w-full h-full top-0 left-0 right-0 bottom-0 bg-black/70 z-[2]" />
